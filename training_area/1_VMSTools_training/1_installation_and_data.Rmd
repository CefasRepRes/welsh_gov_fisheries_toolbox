...
In the instance the data has lower case column names, which can be preferred in SQL for ease of use, the toupper() function, combined with names(), will change their case. This is necessary when using the VMStools package, as the functions are expecting upper case column names.
