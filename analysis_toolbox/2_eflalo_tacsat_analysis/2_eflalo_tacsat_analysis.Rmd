...
```{r join tacsat eflalo_sel, include=FALSE}
...
```{r check gear NAs, include=FALSE}
...
```{r vessel characteristics, include=FALSE}
...
```{r define activity, include=FALSE}
...
```{r speed histogram, include=FALSE}
...
```{r autodetect gears, include=FALSE}
...
```{r fill storeScheme, include=FALSE}
...
```{r speed rule classification, include=FALSE}
...
```{r replace NAs with MIS, include=FALSE}
...
```{r hauling sequences, include=FALSE}
  idx =   which(
...
```{r save tacsat activity, include=FALSE}
...
```{r state to 1 or 0, include=FALSE}
...
```{r create tacsatEflalo, include=FALSE}
...
```{r weight/value 0s, include=FALSE}
