...
### 5. ANALYSIS OF EFLAO AND TACSAT COMBINED ( Is assumed the data input is already clean and quality controlled) ####
      ...
      species_analysis_type = 'all_species_separated' # 'all_species_sum', ' # options: ( all_species_sum, all_species_separated ,   selected_species_sum, selected_species_separated )
