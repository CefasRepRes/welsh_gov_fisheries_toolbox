...
```{r length category, include=FALSE}
...
```{r data product 1, include=FALSE}
...
```{r data product 2, include=FALSE}
...
```{r data product 3, include=FALSE}
...
```{r data product 4, include=FALSE}
...
```{r data product 5, include=FALSE}
...
```{r data product 6, include=FALSE}
...
```{r 0.05 resolution, include=FALSE}
...
```{r 0.01 resolution, include=FALSE}
...
```{r world geometry, include=FALSE}
...
```{r assign spatial grid, include=FALSE}
...
```{r save as geojson, include=FALSE}
...
```{r create data product 1, include=FALSE}
...
```{r save data product 1, include=FALSE}
...
```{r create data products, include=FALSE}
