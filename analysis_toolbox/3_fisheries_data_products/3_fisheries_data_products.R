...
# input folder
inPath = paste0(here(), "\\data\\workflow_outputs\\")

# data products folder
dir.create(paste0(inPath, "data\\workflow_outputs\\data-products"))
outPath = paste0(inPath, "data\\workflow_outputs\\data-products\\")
...
tacsatEflalo$LENGTHCAT <- tacsatEflalo$VE_LEN %>%
  cut(breaks = c(0, 5, 7, 10, "inf"),
...
tacsatEflalo$QUARTER = tacsatEflalo$Month %>%
  cut(breaks = c(0, 4, 7, 10, 12),
    right = FALSE, include.lowest = TRUE,
    labels = quar_labels
  )
...
write.csv(table1.1, paste0(outPath, year, "_table1_1_", analysis_type, ".csv"))
...
table1.2 =
  ...
  mutate(AverageGearWidth = NA %>%
           as.numeric()) %>%
  as.data.frame()

write.csv(table1.2, paste0(outPath, year, "_table1_2_", analysis_type, ".csv"))
...
write.csv(table1.3, paste0(outPath, year, "_table1_3_", analysis_type, ".csv"))
...
write.csv(table1.4, paste0(outPath, year, "_table1_4_", analysis_type, ".csv"))
...
write.csv(table1.5, paste0(outPath, year, "_table1_5_", analysis_type, ".csv"))
...
write.csv(table1.6, paste0(outPath, year, "_table1_6_", analysis_type, ".csv"))
...
st_write(table1.1_geom, paste0(outPath, "table1_1_geom_", analysis_type, ".geojson"), layer = "table1_1_geom_", analysis_type, ".geojson") ## save as geojson
st_write(table1.2_geom, paste0(outPath, "table1_2_geom_", analysis_type, ".geojson"), layer = "table1_2_geom_", analysis_type, ".geojson")
st_write(table1.3_geom, paste0(outPath, "table1_3_geom_", analysis_type, ".geojson"), layer = "table1_3_geom_", analysis_type, ".geojson")
st_write(table1.4_geom, paste0(outPath, "table1_4_geom_", analysis_type, ".geojson"), layer = "table1_4_geom_", analysis_type, ".geojson")
st_write(table1.5_geom, paste0(outPath, "table1_5_geom_", analysis_type, ".geojson"), layer = "table1_5_geom_", analysis_type, ".geojson")
st_write(table1.6_geom, paste0(outPath, "table1_6_geom_", analysis_type, ".geojson"), layer = "table1_6_geom_", analysis_type, ".geojson")
...
ggsave(plot = res1, filename = paste0("table1_1_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)

res2 = plot_function(data_plot = table1.2_geom, col_plot = "sum_intv", col_facet1 = "LE_GEAR", col_facet2 = "Year")
ggsave(plot = res2, filename = paste0("table1_2_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)

res3 = plot_function(data_plot = table1.3_geom, col_plot = "sum_intv", col_facet1 = "LE_GEAR", col_facet2 = "Month")
ggsave(plot = res3, filename = paste0("table1_3_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)

res4 = plot_function(data_plot = table1.4_geom, col_plot = "sum_intv", col_facet1 = "LE_GEAR", col_facet2 = "QUARTER")
ggsave(plot = res4, filename = paste0("table1_4_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)

res5 = plot_function(data_plot = table1.5_geom, col_plot = "sum_intv", col_facet1 = "LE_GEAR", col_facet2 = "Year")
ggsave(plot = res5, filename = paste0("table1_5_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)

res6 = plot_function(data_plot = table1.6_geom, col_plot = "sum_intv", col_facet1 = "LE_GEAR", col_facet2 = "Month")
ggsave(plot = res6, filename = paste0("table1_6_plot_", analysis_type, ".png"), path = plotsPath, width = 16, height = 9, dpi = 300)
