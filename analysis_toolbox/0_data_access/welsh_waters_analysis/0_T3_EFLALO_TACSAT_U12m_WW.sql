...
where  QualifiedAreaCode in ( '27.7.a', '27.7.g', '27.7.f' )  -- This filters the fishing operations occuring only in Welsh Waters 
...
-- ELALO_LE: Extract first the fishing events that occurs aprox. within the Welsh Waters area (initially  defined as  ICES areas 7.a, 7.g, 7.f ) 


--- 1st: extract all trips with MESH SIZE information and save result into a table called #LeWithMesh
...
--- 2nd: extract all trips without MESH SIZE information and 'unite' with the table saved in step 1   
...
order by eflalo_ft_FT_REF, LE_ID  
 ...
 -- 3rd: Delete the temporary table #LeWithMesh
