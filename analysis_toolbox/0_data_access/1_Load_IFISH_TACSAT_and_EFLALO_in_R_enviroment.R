...
eflalo_ft = read.csv(file = '.\\..\\data\\w_o10m_eflalo\\eflalo_ft.csv', header = F, sep = ','  , fileEncoding = 'UTF-8-BOM')
...
eflalo_le = read.csv(file = '.\\..\\data\\w_o10m_eflalo\\eflalo_le.csv', header = F, sep = ','  , fileEncoding = 'UTF-8-BOM')
...
eflalo_spe = read.csv(file = '.\\..\\data\\w_o10m_eflalo\\eflalo_spe.csv', header = F, sep = ','  , fileEncoding = 'UTF-8-BOM')
...
tacsat = read.csv(file = '.\\..\\data\\w_o10_tacsat\\tacsat.csv', header = F, sep = ','  , fileEncoding = 'UTF-8-BOM')
