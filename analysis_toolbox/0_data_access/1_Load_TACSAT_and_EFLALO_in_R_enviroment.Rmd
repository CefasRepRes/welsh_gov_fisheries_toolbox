...
```{r select analysis, include=FALSE}
...
```{r load eflalo_ft, include=FALSE}
...
```{r convert ve_cou, include=FALSE}
...
```{r filter by vessel length, include=FALSE}
...
```{r summarise eflalo ft, include=FALSE}
  head (eflalo_ft_t3)
  str(eflalo_ft_t3)
  dim(eflalo_ft_t3)
...
```{r load eflalo le, include=FALSE}
...
```{r load eflalo spe, include=FALSE}
...
```{r format tacsat columns, include=FALSE}
...
```{r welsh waters analysis, include=FALSE}
