...
outPath   <- "C:\\Users\\rm12\\OneDrive - CEFAS\\Roi\\projects\\datacalls\\ices\\march_2023\\results\\"    #Location where you want to store the datacall  results

ve <- 
  read_ve(paste0(outPath, "table1Save_allyears.csv") ) %>% 
  csq2pos() %>% 
...
le <- 
  read_le(paste0(outPath, "table2Save_allyears.csv") )
