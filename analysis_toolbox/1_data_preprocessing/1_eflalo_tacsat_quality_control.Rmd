...
```{r multi-gear trips, include=FALSE}
...
```{r duplicate trips 1, include=FALSE}
...
```{r duplicate trips 2, include=FALSE}
...
```{r filter departure arrival overlap, include=FALSE}
...
```{r filter overlaps different trips, include=FALSE}
...
```{r overlapping/duplicated trips exploration, include=FALSE}
...
```{r trips in clean eflalo, include=FALSE}
...
```{r investigate common trips, include=FALSE}
...
```{r ft_ref not in tacsat, include=FALSE}
...
```{r single trip exploration, include=FALSE}
...
```{r duplicates removal, include=FALSE}
tacsat_fs%>%
...
```{r remove points on land, include=FALSE}
...
```{r investiagte points on land, include=FALSE}
